...
<div class="row">
	...
	<div class="span6 text-right">
		<a href="<?php echo site_url(SITE_AREA . '/settings/emailer/force_process'); ?>" class="btn"><?php echo lang('em_process_now') ?></a>
		<a href="<?php echo site_url(SITE_AREA . '/settings/emailer/insert_test'); ?>" class="btn"><?php echo lang('em_insert_test_email') ?></a>
	</div>
</div>
